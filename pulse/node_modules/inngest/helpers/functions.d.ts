 ...
 */
export declare const waterfall: <TFns extends ((arg?: any) => any)[]>(fns: TFns, transform?: (prev: any, output: any) => any) => ((...args: Parameters<TFns[number]>) => Promise<Await<TFns[number]>>);
/**
 * Given a value `v`, return `v` if it's not undefined, otherwise return `null`.
 */
export declare const undefinedToNull: (v: unknown) => {} | null;
export declare const parseFnData: (fn: InngestFunction.Any, data: unknown) => {
