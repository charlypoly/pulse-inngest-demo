...
import { type ResolveSchema, type ValidSchemaInput, type ValidSchemaOutput } from "../helpers/validators";
import { type MinimalEventPayload, type PayloadForAnyInngestFunction } from "../types";
 ...
 * @public
 */
export declare const referenceFunction: <TArgs extends InngestFunctionReference.HelperGenericArgs<TFnInput, TFnOutput>, TFnInput extends ValidSchemaInput = import("../helpers/validators/zod").ValidZodValue, TFnOutput extends ValidSchemaOutput = import("../helpers/validators/zod").ZodTypeAny>({ functionId, appId, }: TArgs extends InngestFunction.Any ? Omit<InngestFunctionReference.HelperArgs<any, any>, "schemas"> : TArgs) => InngestFunctionReference.HelperReturn<TArgs>;
/**
 * A reference to an `InngestFunction` that can be used to represent both local
 * and remote functions without pulling in the full function definition (i.e.
 * dependencies).
