...
const StepError_1 = require("../StepError");
...
class V1InngestExecution extends InngestExecution_1.InngestExecution {
    ...
    async transformNewSteps(steps) {
        return Promise.all(steps.map(async (step) => {
            ...
            if (step.op !== types_1.StepOpCode.InvokeFunction) {
                return step;
            }
            const onSendEventHooks = await (0, InngestMiddleware_1.getHookStack)(this.options.fn["middleware"], "onSendEvent", undefined, {
            ...
            const transformedPayload = await ((_a = onSendEventHooks.transformInput) === null || _a === void 0 ? void 0 : _a.call(onSendEventHooks, {
                payloads: [
                    Object.assign(Object.assign({}, ((_c = (_b = step.opts) === null || _b === void 0 ? void 0 : _b.payload) !== null && _c !== void 0 ? _c : {})), { name: consts_1.internalEvents.FunctionInvoked }),
                ],
            }));
            const newPayload = InngestStepTools_1.invokePayloadSchema.parse((_e = (_d = transformedPayload === null || transformedPayload === void 0 ? void 0 : transformedPayload.payloads) === null || _d === void 0 ? void 0 : _d[0]) !== null && _e !== void 0 ? _e : {});
    ...
    async executeStep({ id, name, opts, fn, displayName, }) {
        ...
        return ((0, promises_1.runAsPromise)(fn)
            ...
            .catch((error) => {
            return Object.assign(Object.assign({}, outgoingOp), { op: types_1.StepOpCode.StepError, 
    ...
    async startExecution() {
         ...
         */
        (0, promises_1.runAsPromise)(() => this.userFnToRun(this.fnArg))
            // eslint-disable-next-line @typescript-eslint/no-misused-promises
            .finally(async () => {
            var _a, _b, _c, _d, _e, _f;
            await ((_b = (_a = this.state.hooks) === null || _a === void 0 ? void 0 : _a.afterMemoization) === null || _b === void 0 ? void 0 : _b.call(_a));
    ...
    async transformOutput(dataOrError) {
        ...
        if (typeof error !== "undefined") {
             ...
             */
            let retriable = !(error instanceof NonRetriableError_1.NonRetriableError || error instanceof StepError_1.StepError);
            if (retriable && error instanceof RetryAfterError_1.RetryAfterError) {
                retriable = error.retryAfter;
            }
            const serializedError = (0, errors_1.minifyPrettyError)((0, errors_1.serializeError)(error));
    ...
    createExecutionState() {
        const d = (0, promises_1.createDeferredPromiseWithStack)();
    ...
    createFnArg() {
        ...
        if (this.options.isFailureHandler) {
            const eventData = zod_1.z
                .object({ error: types_1.jsonErrorSchema })
    ...
    createStepTools() {
        ...
        const stepHandler = async ({ args, matchOp, opts, }) => {
            ...
            const step = Object.assign(Object.assign({}, opId), { hashedId, 
                ...
                fn: (opts === null || opts === void 0 ? void 0 : opts.fn) ? () => { var _a; return (_a = opts.fn) === null || _a === void 0 ? void 0 : _a.call(opts, ...args); } : undefined, fulfilled: Boolean(stepState), displayName: (_b = opId.displayName) !== null && _b !== void 0 ? _b : opId.id, handled: false, handle: () => {
                    if (step.handled) {
                        return false;
                    }
                    step.handled = true;
                    if (stepState) {
                        ...
                        if (typeof stepState.data !== "undefined") {
                            ...
                            this.state.recentlyRejectedStepError = new StepError_1.StepError(opId.id, stepState.error);
        ...
        return (0, InngestStepTools_1.createStepTools)(this.options.client, this, stepHandler);
    }
    getUserFnToRun() {
        if (!this.options.isFailureHandler) {
