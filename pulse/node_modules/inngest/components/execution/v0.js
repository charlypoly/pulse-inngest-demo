...
class V0InngestExecution extends InngestExecution_1.InngestExecution {
    ...
    async _start() {
        ...
        try {
            ...
            const userFnPromise = (0, promises_1.runAsPromise)(() => this.userFnToRun(this.fnArg));
            let pos = -1;
            do {
                if (pos >= 0) {
            ...
            if (runStep) {
                ...
                const outgoingUserFnOp = Object.assign(Object.assign({}, tickOpToOutgoing(userFnOp)), { op: types_1.StepOpCode.Step });
    ...
    createFnArg() {
        ...
        const stepHandler = ({ args, matchOp, opts }) => {
            ...
            return new Promise((resolve, reject) => {
                this.state.tickOps[opId.id] = Object.assign(Object.assign(Object.assign({}, opId), ((opts === null || opts === void 0 ? void 0 : opts.fn) ? { fn: () => { var _a; return (_a = opts.fn) === null || _a === void 0 ? void 0 : _a.call(opts, ...args); } } : {})), { resolve,
                    reject, fulfilled: false });
            });
        };
        const step = (0, InngestStepTools_1.createStepTools)(this.options.client, this, stepHandler);
